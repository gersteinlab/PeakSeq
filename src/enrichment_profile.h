...
public:
    ...
    t_enrichment_profile(char* chr_id, vector<t_mapped_fragment*>* fragments, int enrichment_mapped_fragment_length);
    t_enrichment_profile(char* chr_id, t_mapped_fragment** fragments, int enrichment_mapped_fragment_length);
	t_enrichment_profile(char* chr_id, char* sgr_fp, int enrichment_mapped_fragment_length);
