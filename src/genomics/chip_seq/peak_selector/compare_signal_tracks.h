...
int count_read_in_region(int start, int end, int& last_frag_i, vector<t_fragment*>* frag_list, int enrichment_fragment_length);
double count_read_in_extended_region(int start, int end, int& last_frag_i, vector<t_fragment*>* frag_list, int enrichment_fragment_length);
