...
void t_string::copy(char* dest_string, char* src_string)
{
...
char* t_string::substring(char* str, int i, int j)
{
	...
	if(i > j ||
		i > t_string::string_length(str) || 
		j > t_string::string_length(str))
	{
		return(NULL);
	}
	else
...
bool t_string::compare_substrings_ci(char* str, char* sub_str)
{
...
bool t_string::ends_with(char* string)
{
	...
	for(int i_sub = string_length(string) - 1; i_sub >= 0; i_sub--)
	{
...
bool t_string::starts_with(char* full_string, char* sub_str)
{
